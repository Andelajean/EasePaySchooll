...
<body class="flex h-screen bg-gray-100">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <header class="bg-red-600 text-white shadow p-4 flex justify-between items-center">
      <h1 class="text-lg font-semibold">SPH</h1>
   ...
   <main class="flex-1 p-6">
    ...
    <h2 class="text-2xl font-bold">Gestion des Candidats pour la Filière Science Politique et  Humanité </h2>
...
<div id="resultsModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                <form id="resultsForm" enctype="multipart/form-data" action="{{ route('share.results.politique') }}" method="post">
                    @csrf
                    <div class="mb-4">

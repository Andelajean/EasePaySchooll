...
<head>
    ...
    <title>Inscription au concours - SPH</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h2 class="text-center">Inscription au concours dans la filière Science Politique et Humaine</h2>
                    </div>
                    @if(session('success'))
...
@endif
                    ...
                    <form id="inscriptionForm" method="POST" action="{{route('politique.store')}}" enctype="multipart/form-data">
                        @csrf

...
<body class="h-screen flex items-center justify-center">
 ...
 <!-- Loader -->
  ...
  @endif
    ...
    <h2 class="text-2xl font-bold text-center text-indigo-700 mb-6">Profil Administrateur</h2>
 ...
 required>
        ...
        <div>
            <label for="identifiant" class="block text-gray-700 font-medium">Nouveau Mot de passe</label>

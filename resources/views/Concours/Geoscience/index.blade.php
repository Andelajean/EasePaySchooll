            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h2 class="text-center">Inscription au concours dans la filière Geoscience,Environnement et Agro-Industrie</h2>
                    </div>
...
@endif
                    ...
                    <form id="inscriptionForm" method="POST" action="{{route('geoscience.store')}}" enctype="multipart/form-data">
                        @csrf

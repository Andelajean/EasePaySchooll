...
<body class="flex h-screen bg-gray-100">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <header class="bg-red-600 text-white shadow p-4 flex justify-between items-center">
      <h1 class="text-lg font-semibold"> IGEA (Liste des candidats)</h1>
   ...
   <main class="flex-1 p-6">
    ...
    <h2 class="text-2xl font-bold">Liste Des Candidats Par ordre alphabetique pour la Filière  IGEA</h2>
...
<div class="flex justify-end space-x-4 mb-6">
    <a href="{{ route('candidates.print-rooms.igea') }}" target="_blank"
    ...
    <form method="POST" action="{{ route('candidates.share-rooms.geoscience') }}">
    @csrf

            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h2 class="text-center">Inscription au concours dans la filière Science Politique et Humanités</h2>
                    </div>
...
@endif
                    ...
                    <form id="inscriptionForm" method="POST" action="{{route('civil.store')}}" enctype="multipart/form-data">
                        @csrf

...
<head>
    ...
    <title>Inscription au concours - Management et Finance</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h2 class="text-center">Inscription au concours dans la filière Management et Finance</h2>
                    </div>
...
@endif
                    ...
                    <form id="inscriptionForm" method="POST" action="{{route('finance.store')}}" enctype="multipart/form-data">
                        @csrf

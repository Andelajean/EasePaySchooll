...
<body class="flex h-screen bg-gray-100">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <header class="bg-red-600 text-white shadow p-4 flex justify-between items-center">
      <h1 class="text-lg font-semibold">Management et Finance (M & F)</h1>
   ...
   <main class="flex-1 p-6">
    ...
    <h2 class="text-2xl font-bold">Gestion des Candidats pour la Filière Management et Finance</h2>
    <div class="flex space-x-4">
         <!-- Bouton Tri Alphabétique -->
         <a href="{{ route('salles.attribution', ['alphabetical' => true]) }}" 
...
<script>
    ...
    function shareResults() {
        ...
        fetch("{{ route('share.results.finance') }}", {
            method: 'POST',
            body: formData,
            headers: {

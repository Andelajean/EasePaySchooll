...
<html>
<head>
    <title>Répartition des salles</title>
    <style>
...
<body>
    <h1 style="text-align: center; margin-bottom: 20px;">Répartition des salles d'examen pour la filière Management et Finace</h1>

...
<div class="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-6 mb-6">
    ...
    <!-- Titre principal -->
    <h2 class="text-2xl font-bold text-center text-blue-600 mb-4">Vous êtes presque là</h2>
    <p class="text-center text-gray-600">Étape 2/2 - Veuillez entrer les classes et leurs différents montants</p>

    <!-- Formulaire -->
    <form id="classesForm" action="{{ route('traitement.classe', ['id' => $id]) }}" method="post">
        @csrf

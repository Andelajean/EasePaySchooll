...
<div class="email-container">
    ...
    <div class="email-content">
        ...
        <p>Votre compte a été créé avec succès sur la plateforme <strong>EasePaySchool</strong>. Vous pouvez désormais gérer vos paiements de frais de scolarité de manière simple et rapide, où que vous soyez.</p>
        
        <p><strong>Identifiant de l'établissement : {{ $ecole['identifiant'] }}</strong></p>

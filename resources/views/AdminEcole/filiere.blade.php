        ...
        <div class="flex justify-between items-center bg-white p-4 shadow-md">
            ...
            < <div class="w-1/3">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('profil', ['id' => Session::get('ecole')->id]) }}" class=" text-white px-4 py-2 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <div>
                            ...
                            <ul class="flex space-x-2 text-sm text-gray-600">
                                ...
                                <li><span class="text-blue-400">/ Paiement Par Classe </span></li>
                            </ul>
                        </div>
                        
                        <!-- Sélection de la Banque -->
                        <div>
                        <form action="{{ route('filiere') }}" method="GET" class="space-y-4">
                                <div>

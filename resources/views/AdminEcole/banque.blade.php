            ...
            <div class="w-64 bg-gray-800 text-white h-full p-4">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div id="paiements" class="hidden pl-6 bg-gray-700">
                            <ul class="mt-2 space-y-2">
                                ...
                                <li><a href="{{route('niveau')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('niveau') ? 'bg-blue-700 text-white' : '' }}">Paiement Par Niveau</a></li>
                                <li><a href="{{route('filiere')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('filiere') ? 'bg-blue-700 text-white' : '' }}">Paiement Par Filiere</a></li>
                                ...
                                <li><a href="{{route('classe_filiere')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('classe_filiere') ? 'bg-blue-700 text-white' : '' }}">Paiement Par Classe et Par Filiere</a></li>
                    ...
                    <div>
                        ...
                        <ul class="mt-2 space-y-2">
                                <li><a href="{{route('fac.distribuer_polo')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('fac.distribuer_polo') ? 'bg-blue-700 text-white' : '' }}">Distribuer Les Polo</a></li>
                                <li><a href="{{route('fac.distribuer_badge')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('fac.distribuer_badge') ? 'bg-blue-700 text-white' : '' }}">Distribuer Les Badges</a></li>
                                <li><a href="{{route('fac.badge')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('fac.badge') ? 'bg-blue-700 text-white' : '' }}">Liste des Badges Distribués</a></li>
                                <li><a href="{{route('fac.polo')}}" class="block px-4 py-2 rounded hover:bg-blue-700 {{ request()->routeIs('fac.polo') ? 'bg-blue-700 text-white' : '' }}">Liste des Polo Distribués</a></li>
                        </ul>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <div>
                            ...
                            <ul class="flex space-x-2 text-sm text-gray-600">
                                ...
                                <li><span class="text-blue-400">/ Paiement Par Banque</span></li>
                            </ul>
                        </div>
                        
                        <!-- Sélection de la Banque -->
                        <div>
                            <form action="{{ route('banque') }}" method="GET" class="space-y-2">
                                <label for="classe" class="block text-sm font-medium text-gray-700">Choisissez une Banque :</label>
                                <select id="classe" name="classe" class="w-full p-2 border rounded-lg">
                                ...
                                <input type="date" class="w-full p-2 border rounded-lg" id="date" name="date" required>
                                <button type="submit" class="mt-2 w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700">Rechercher</button>
                            </form>
                        </div>

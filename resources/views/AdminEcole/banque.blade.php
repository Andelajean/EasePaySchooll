...
<head>
    ...
    <title> Rapport des Paiements pour la banque: {{ $banque }}</title>
                        ...
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="{{route('banque')}}">Paiement Par Banque</a></li>
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Paiement Par Banque</span></li>
                </ul>
            </div>
        </div>
...
<!-- main content end -->
<!-- Modale avec un tableau généré dynamiquement pour afficher les détails de l'élève -->
<!-- main content end -->

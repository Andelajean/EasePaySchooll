                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <div>
                            ...
                            <ul class="flex space-x-2 text-sm text-gray-600">
                                ...
                                <li><span class="text-blue-400">/ Paiement Par Classe et Par Banque</span></li>
                            </ul>
                        </div>
                        
                        <!-- Sélection de la Banque -->
                        <div>
                        <form action="{{ route('banque_classe') }}" method="GET" class="space-y-4">
                                <div>
                        ...
                        <div>
                            <form action="{{ route('banque_classe') }}" method="GET">

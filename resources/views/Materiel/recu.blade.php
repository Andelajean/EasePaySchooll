...
<head>
    ...
    <title>Rapport Du Materiel pour la classe:{{$classeSelectionnee}} </title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <li class="active"><a href="{{route('recus')}}">Materiel Recu</a></li>
                                </ul>
                            </li>
                             <li >
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Materiel par classe</span></li>
                </ul>
            </div>
        </div>
        <div class="col-sm-6 clearfix">  
 <form action="{{ route('recus') }}" method="GET" id="classeForm">
            ...
            <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-center">
                    <h4 class="header-title mb-0" id="table-header">
                        Liste du materiel reçu par classe
                    </h4>
                    <!-- Bouton Imprimer -->

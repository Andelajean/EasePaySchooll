...
<head>
    ...
    <title>Rapport de distribution des uniformes</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li >
                             ...
                             <li class="active">
                                ...
                                <ul class="collapse">
                                <li class="active"><a href="{{route('distribution')}}">Distribution Des Uniformes Scolaires</a></li>
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('dashboard_ecole') }}">Uniformes</a></li>
                    <li><span>Distribution Des Uniformes Scolaires</span></li>
                </ul>
            </div>
        </div>
...
<div class="form-group mb-2">
    ...
    <input type="search" class="form-control" id="nom_eleve" name="nom_eleve" placeholder="Recherche par nom complet" autocomplete="off">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <tr class="heading-td">
                ...
                <td class="buy">Date réception</td>
                <td class="sell">Statut Matériel</td>
                <td class="trends">Reste</td>
                <td class="trends">Action</td>
            </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="receptionModalLabel">Distribution Des Uniformes Scolaires</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="{{ route('distribution.uniforme') }}" method="POST">
          @csrf
          <input type="hidden" name="eleve_id" id="eleve_id">

          <div class="form-check">
            <input class="form-check-input" type="radio" name="uniforme" id="materiel_ok" value="ok" checked>
            <label class="form-check-label" for="materiel_ok">Uniforme OK</label>
          </div>

          <div class="form-check">
            <input class="form-check-input" type="radio" name="uniforme" id="materiel_non_ok" value="non_ok">
            <label class="form-check-label" for="materiel_non_ok">Uniforme NON OK</label>
          </div>

          <div class="form-group" id="materiel_restante_group" style="display: none;">
            <label for="materiel_restante">Liste des Uniformes manquant :</label>
...
<!-- main content end -->
    ...
    <script src="/jscript/banque_impression.js"></script>
     <script src="/jscript/distribution.js"></script>
</body>
